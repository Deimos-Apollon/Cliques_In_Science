...
class SqlWriter:
    ...
    def add_author(self, given_name, family_name):
        ...
        '''
        self.__execute_query(insert_author_query)
    ...
    def add_work(self, doi, year):
        insert_work_query = fr'''
                ...
                VALUES ("{doi}", {year})
        '''
        self.__execute_query(insert_work_query)
    ...
    def add_author_has_work(self, author_id, doi):
        ...
        '''
        self.__execute_query(insert_author_has_work_query)
    ...
    def add_work_cites_work(self, work_doi, src_doi):
        ...
        '''
        self.__execute_query(insert_query)
    ...
    def add_edge_to_graph(self, entry_id):
        insert_edge_query = fr'''
                ...
                VALUES ({entry_id})
        '''
        self.__execute_query(insert_edge_query)
    ...
    def add_edge_in_component(self, component_color, edge_id):
        ...
        '''
        self.__execute_query(add_query)
